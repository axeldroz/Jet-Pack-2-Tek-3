...
** Last update Wed Jul 13 16:45:24 2016 Loïc GIGOMAS
*/
...
int		cell_jump(t_pair *p, NSD void **cell, NSD t_pair *b, NSD size_t pos)
{
  t_player	*pl;

  pl = p->second;
  pl->entity->speed_y *= (1 + pl->entity->speed_y);
  return (0);
}
